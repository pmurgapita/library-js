      ...
      if (e.target.dataset.id === element.id) {
        ...
        toggleReadCard.forEach((readPrint) => {
          if (readPrint.dataset.id === element.id) {
            readPrint.textContent =
              readPrint.textContent === "Yes" ? "No" : "Yes";
          }
          ...
          toggleReadButton.forEach((readTextButton) => {
            if (readTextButton.dataset.id === element.id) {
              readTextButton.textContent =
                readTextButton.textContent === "Read" ? "Unread" : "Read";
            }
          });
        });
      }
...
function showError() {
    if (title.validity.valueMissing) {
        span.textContent = "You need to insert a title.";
    } else if (author.validity.valueMissing) {
        span.textContent = "You need to insert an author.";
    } else if (pages.validity.valueMissing) {
        span.textContent = "You need to insert the number of pages.";
    }
